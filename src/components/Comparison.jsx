    ...
    <section className="py-4 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
            ...
            {comparisons.map((item, index) => (
              ...
              >
                ...
                <div className="text-center flex items-center justify-center">
                  <div className="inline-flex items-start space-x-2 px-4 py-2 bg-green-50 rounded-lg border border-green-200">
          ...
          {/* CTA Footer */}
          <div className="p-8 bg-gradient-to-r from-accent/5 to-highlight/5 border-t border-gray-100">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <div>
                <h3 className="text-2xl font-bold text-primary mb-2">Ready to Transform Your Legal Workflow?</h3>
                <p className="text-gray-600">Join 500+ leading law firms already using AskFides.</p>
              </div>
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: '0 20px 40px rgba(37, 99, 235, 0.3)' }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-accent to-highlight text-white font-semibold rounded-xl shadow-lg whitespace-nowrap"
              >
                Get Started Free
              </motion.button>
            </div>
